"""
AI Interview Platform - Flask Backend with Authentication
This version includes JWT-based authentication with SQLite database
"""
...
try:
    mongo_uri = os.getenv('MONGO_URI', 'mongodb+srv://harsh0801004:8857090609@harshkoshti.b208der.mongodb.net/ai_interview?retryWrites=true&w=majority&appName=harshkoshti')
    ...
    print("[WARN] App will run without MongoDB (emotion tracking disabled)")
...
from models import User, Interview, Question  # noqa: F401
...
def health_check():
    return jsonify({
        'status': 'healthy',
        'database': 'connected',
        'mongodb': 'connected' if user_collection else 'disabled'
    }), 200
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("AI Interview Platform - Backend Server with Authentication")
    print("=" * 60)
    print("Server running on: http://localhost:5000")
    print("Auth endpoints:")
    print("  POST /api/auth/register - Register new user")
    print("  POST /api/auth/login    - Login user")
    print("  GET  /api/auth/me       - Get current user (requires JWT)")
    print("Student endpoints:")
    print("  GET  /api/student/stats           - Student dashboard stats")
    print("  GET  /api/student/recent-activity  - Student interview history")
    print("HR endpoints (role=hr required):")
    print("  GET  /api/hr/candidates            - All candidate results")
    print("  PUT  /api/hr/candidates/:id/status  - Update review status")
    print("  GET  /api/hr/questions              - List questions")
    print("  POST /api/hr/questions              - Create question")
    print("  PUT  /api/hr/questions/:id          - Update question")
    print("  DELETE /api/hr/questions/:id         - Delete question")
    print("=" * 60)
